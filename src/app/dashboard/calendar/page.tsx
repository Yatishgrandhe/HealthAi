...
export default function CalendarPage() {
  ...
  const loadCalendarData = async () => {
    ...
    try {
        ...
        if (plan.is_active) {
          ...
          for (let day = 1; day <= 90; day++) {
            ...
            if (dayData) {
              ...
              const existingDailyPlan = dailyFitnessPlans?.find((dp: any) => 
      ...
      postureChecks?.forEach((check: any) => {
        ...
        if (dayData) {
          ...
          dayData.events.push({
            ...
            type: 'posture',
            title: 'Posture Check',
            description: `Score: ${check.posture_score || 0}/100`,
            status: 'completed',
            data: check,
      ...
      therapySessions?.forEach((session: any) => {
      ...
      fitnessProgress?.forEach((progress: any) => {
